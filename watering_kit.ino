...
void water_flower() {
  ...
  // Sensor 1 - WATER AT 40%, STOP AT 55%
  ...
  // Sensor 2 - WATER AT 40%, STOP AT 55%
  if (sensor_active[1] && moisture2_value < 40) {
  ...
  // Sensor 3 - WATER AT 40%, STOP AT 55%
  if (sensor_active[2] && moisture3_value < 40) {
  ...
  // Sensor 4 - WATER AT 40%, STOP AT 55%
  if (sensor_active[3] && moisture4_value < 40) {
...
void drawflower(void) {
  if (sensor_active[0]) {
    u8g.drawXBMP(0, 0, 32, 30, moisture1_value < 40 ? bitmap_bad : bitmap_good);
  }
  if (sensor_active[1]) {
